...
import Model.ThongKeDonBan;
import Model.ThongKeSPBan;
import Model.ThongKeBieuDoNam;
...
"GROUP BY TenSP";
    public List<Long> selectdaonhthu_ngay_label() {
        ...
        try {
            ResultSet rs = SQLConlection.query(sql_doanhthutong_ngay_label);
            while (rs.next()) {
     ...
     public List<Integer> selecttongdon_ngay_label() {
        ...
        try {
            ResultSet rs = SQLConlection.query(sql_tongdonban_ngay_label);
            while (rs.next()) {
     ...
     public List<Integer> selecttongdon_thang_label() {
        ...
        List<Integer> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_tongdonban_thang_label);
            while (rs.next()) {
                list.add(rs.getInt(1));
            }
            rs.getStatement().getConnection().close();
      ...
      public List<Integer> selecttongdon_nam_label() {
        ...
        List<Integer> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_tongdonban_nam_label);
            while (rs.next()) {
                list.add(rs.getInt(1));
            }
            rs.getStatement().getConnection().close();
       ...
       public List<Integer> selecttongsp_thang_label() {
        ...
        List<Integer> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_tongspban_thang_label);
            while (rs.next()) {
                list.add(rs.getInt(1));
            }
            rs.getStatement().getConnection().close();
        ...
        List<Integer> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_tongspban_nam_label);
            while (rs.next()) {
                list.add(rs.getInt(1));
            }
            rs.getStatement().getConnection().close();
        ...
        List<Integer> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_tongspban_ngay_label);
            while (rs.next()) {
                list.add(rs.getInt(1));
            }
            rs.getStatement().getConnection().close();
    ...
    public List<Long> selectdaonhthu_Thang_label() {
        ...
        List<Long> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_doanhthutong_thang_label);
            while (rs.next()) {
                list.add(rs.getLong(1));
            }
            rs.getStatement().getConnection().close();
    ...
    public List<Long> selectdaonhthu_nam_label() {
        ...
        List<Long> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_doanhthutong_nam_label);
            while (rs.next()) {
                list.add(rs.getLong(1));
            }
            rs.getStatement().getConnection().close();
    ...
    public List<Long> selectsosanh_Thang_label() {
        ...
        List<Long> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_sosanh_thang_label);
            while (rs.next()) {
                list.add(rs.getLong(1));
            }
            rs.getStatement().getConnection().close();
    ...
    public List<Long> selectsosanh_ngay_label() {
        ...
        List<Long> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_sosanh_ngay_label);
            while (rs.next()) {
                list.add(rs.getLong(1));
            }
            rs.getStatement().getConnection().close();
     ...
     public List<Long> selectsosanh_nam_label() {
        ...
        List<Long> list = new ArrayList<>();
        try {
            ResultSet rs = SQLConlection.query(sql_sosanh_nam_label);
            while (rs.next()) {
                list.add(rs.getLong(1));
            }
            rs.getStatement().getConnection().close();
