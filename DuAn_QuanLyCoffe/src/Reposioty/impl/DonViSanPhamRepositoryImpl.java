...
import Reposioty.DonViSanPhamRepository;

/**
 *
 * @author Admin
 */
public class DonViSanPhamRepositoryImpl implements DonViSanPhamRepository{
    ...
    public void insert(DonViSanPham dv) {
        SQLConlection.update(insert, dv.getID_DonviSP(), dv.getTenDonvi(), dv.getKichthuoc(),dv.getThemTien());
    }

    @Override
    public void update(DonViSanPham dv) {
        SQLConlection.update(sqlUpdate, dv.getTenDonvi(), dv.getKichthuoc(),dv.getThemTien(), dv.getID_DonviSP());
    }

    @Override
    public void delete(String id) {
        SQLConlection.update(sqlDelete, id);
    }
