...
import Reposioty.HoaDonRepository;
...
public class HoaDonRepositoryImpl implements HoaDonRepository {
    ...
    public void insert(Hoadon Entity) {
        Helper.SQLConlection.update(INSERT_SQL, Entity.getIdNhanVien(), Entity.getNgayTao(), Entity.isTrangThai(),
    ...
    public void updateThanhToan(Hoadon Entity) {
        Helper.SQLConlection.update(UPDATE_SQL_TrangThaiTT, Entity.isTrangThaiTT(), Entity.getIdHoaDon());
    }

    @Override
    public void delete(Hoadon Entity) {
        Helper.SQLConlection.update(DELETE_SQL, Entity.getIdHoaDon());
    }

    public void updatekh(Hoadon Entity) {
        Helper.SQLConlection.update(UPDATE_SQL_khachhang, Entity.getSDT(), Entity.getTen(), Entity.getTienShip(), Entity.getDiaChi(), Entity.getIdHoaDon());
    }
    ...
    public void updateTrangThai(Hoadon Entity) {
        Helper.SQLConlection.update(UPDATE_SQL_TrangThai, Entity.isTrangThai(), Entity.getIdHoaDon());
    }

    @Override
    public void updateThanhtien(Hoadon Entity) {
        Helper.SQLConlection.update(UPDATE_SQL_ThanhTien, Entity.getThanhTien(), Entity.getIdHoaDon());
    }

    @Override
    public void updateLydohuy(Hoadon Entity) {
        Helper.SQLConlection.update(UPDATE_SQL_Ly_DO, Entity.getLyDoHuy(), Entity.getIdHoaDon());
    }

    @Override
    public void updateSLSPHUY(Hoadon Entity) {
        Helper.SQLConlection.update(UPDATE_SQL_DEM_SP_HUY, Entity.getSlSanPhamHuy(), Entity.getIdHoaDon());
    }
