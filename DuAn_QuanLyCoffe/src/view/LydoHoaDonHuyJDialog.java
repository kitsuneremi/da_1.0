...
public class LydoHoaDonHuyJDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LydoHoaDonHuyJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LydoHoaDonHuyJDialog dialog = new LydoHoaDonHuyJDialog(new javax.swing.JFrame(), true, hds);
