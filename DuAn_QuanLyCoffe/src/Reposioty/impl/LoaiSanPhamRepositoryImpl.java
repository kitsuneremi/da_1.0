...
import Reposioty.LoaiSanPhamRepository;
/**
 *
 * @author Admin
 */
public class LoaiSanPhamRepositoryImpl implements LoaiSanPhamRepository{
    ...
    public void insert(LoaiSanPham lsp) {
        SQLConlection.update(insert, lsp.getID_LoaiSP(),lsp.getTenLoai());
    }

    @Override
    public void update(LoaiSanPham lsp) {
        SQLConlection.update(sqlUpdate, lsp.getTenLoai(), lsp.getID_LoaiSP());
    }
