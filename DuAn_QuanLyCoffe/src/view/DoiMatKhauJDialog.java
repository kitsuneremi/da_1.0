...
//        }
    ...
    private boolean check() {
        try {
            ...
            if (CheckNull.Check(txtPassOld, "Mật khẩu không được bỏ trống !!!")) {
                return false;
            }
            if (CheckNull.Check(txtPassNew1, "Mật khẩu mới không được bỏ trống !!!")) {
                return false;
            }
            if (CheckNull.Check(txtPassNew2, "Xác nhân mật khẩu không được bỏ trống !!!")) {
                return false;
            }
        } catch (Exception e) {
            e.printStackTrace();
