...
import Reposioty.GiamGiaRepository;
...
public class GiamGiaRepositoryImpl implements GiamGiaRepository {
    ...
    public void insert(GiamGia Entity) {
        SQLConlection.update(INSERY_SQL, Entity.getTenSK(), Entity.getIdnhanvien(), Entity.getNgayBD(), Entity.getNgayKT());
    }

    @Override
    public void update(GiamGia Entity) {
        SQLConlection.update(UPDATE_SQL, Entity.getTenSK(), Entity.getId_GiamGia());
    }
...
//                e.setGiamGia(rs.getInt("Giam"));
    ...
    public void updateDateFinsh(GiamGia e) {
        ...
        SQLConlection.update(sql, e.getNgayKT(), e.getId_GiamGia());
    }
