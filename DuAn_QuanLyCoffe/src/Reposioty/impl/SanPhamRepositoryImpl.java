...
import Reposioty.SanPhamRepository;
/**
 *
 * @author Admin
 */
...
String update_size2 = "update SanPham set ID_DonviSP=?";
    ...
    public void insert(SanPham sp) {
        ...
        SQLConlection.update(insert, sp.getId_sp(), sp.getTen_sp(), sp.getGia_sp(),sp.getId_donviSP(),
                sp.getId_loaiSP(), sp.isTrangthai(), sp.getHinh());
    }

    @Override
    public void update(SanPham sp) {
        SQLConlection.update(update, sp.getTen_sp(), sp.getGia_sp(), sp.getId_donviSP(),
                sp.getId_loaiSP(), sp.isTrangthai(), sp.getHinh(), sp.getId_sp());
    }
    
    public void update_size(String size, String idSP){
        SQLConlection.update(update_size, size,idSP);
    }
    
    public void update_size2(String size){
        SQLConlection.update(update_size2, size);
    }
    @Override
    public void delete(String id) {
        SQLConlection.update(update_trangtrai, id);
    }
