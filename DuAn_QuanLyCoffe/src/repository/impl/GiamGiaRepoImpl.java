 ...
 * @author User1
 */
public class GiamGiaRepoImpl implements GiamGiaRepository{
    ...
    public void insert(GiamGia Entity) {
        SQLCollection.update(INSERY_SQL, Entity.getTenSK(), Entity.getIdnhanvien(), Entity.getNgayBD(), Entity.getNgayKT());
    }

    @Override
    public void update(GiamGia Entity) {
       SQLCollection.update(UPDATE_SQL, Entity.getTenSK(), Entity.getId_GiamGia());
    }

    @Override
    public void delete(String id) {
       SQLCollection.update(DELETE_SQL, id);
    }
...
//                e.setGiamGia(rs.getInt("Giam"));
    ...
    public void updateDateFinsh(GiamGia e) {
       ...
       SQLCollection.update(sql, e.getNgayKT(), e.getId_GiamGia());
    }
