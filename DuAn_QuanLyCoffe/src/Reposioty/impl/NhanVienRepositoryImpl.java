...
import Reposioty.NhanVienRepository;
...
public class NhanVienRepositoryImpl implements NhanVienRepository {
    ...
    public void insert(NhanVien Entity) {
        SQLConlection.update(INSERT_SQL, Entity.getId_Nhanvien(), Entity.getTenNV(), Entity.isGender(), Entity.getNgaysinh(),
    ...
    public void update(NhanVien Entity) {
        SQLConlection.update(UPDATE_SQL, Entity.getTenNV(), Entity.isGender(), Entity.getNgaysinh(), Entity.getDiaChi(), Entity.getEmail(),
    ...
    public void delete(String id) {
        SQLConlection.update(DELETE_SQL, id);
    }
    ...
    public void update_pass(String code, String email){
        SQLConlection.update(update_pass, code, email);
    }
    ...
    public int select_Max_id_java() {
        try {
            ...
            ResultSet rs = SQLConlection.query(sql);
            while (rs.next()) {
                return rs.getInt(1);
            }
        } catch (Exception e) {
    ...
    public String selectByEmail(String maill) {
        ...
        try {
            ...
            ResultSet rs = SQLConlection.query(sql_email);
            while (rs.next()) {
