...
public class QuanLyHoaDon extends javax.swing.JPanel {
    ...
    HoaDonRepoImpl repo = new HoaDonRepoImpl();
            ...
            if (st != "") {
                if ("".equals(mahd)) {
                    if ("".equals(manv)) {
                        sql = switch (t) {
                            case 0 ->
                                "select * from hoadon where ttthanhtoan = 0 and ngaytao >" + st.toString();
                            case 1 ->
                                "select * from hoadon where ttthanhtoan = 1 and ngaytao >" + st.toString();
                            default ->
                                "select * from hoadon where ngaytao >" + st.toString();
                        };
                    } else {
                        sql = switch (t) {
                            case 0 ->
                                "select * from hoadon where ttthanhtoan = 0 and id_nhanvien =" + manv + " and ngaytao >" + st.toString();
                            case 1 ->
                                "select * from hoadon where ttthanhtoan = 1 and id_nhanvien =" + manv + " and ngaytao >" + st.toString();
                            default ->
                                "select * from hoadon where id_nhanvien =" + manv + " and ngaytao >" + st.toString();
                        };
                    }
                } else {
                    if ("".equals(manv)) {
                        sql = switch (t) {
                            case 0 ->
                                "select * from hoadon where ngaytao >" + st.toString() + " and ttthanhtoan = 0";
                            case 1 ->
                                "select * from hoadon where ngaytao >" + st.toString() + " and ttthanhtoan = 1";
                            default ->
                                "select * from hoadon where ngaytao >" + st.toString();
                        };
                    } else {
                        sql = switch (t) {
                            case 0 ->
                                "select * from hoadon where id_hoadon = " + mahd + " ngaytao >" + st.toString() + " and ttthanhtoan = 0 and manv =" + manv;
                            case 1 ->
                                "select * from hoadon where id_hoadon = " + mahd + " ngaytao >" + st.toString() + " and ttthanhtoan = 1 and manv =" + manv;
                            default ->
                                "select * from hoadon where id_hoadon = " + mahd + " ngaytao >" + st.toString() + " and manv =" + manv;
                        };
                    }
                }
            } else {
