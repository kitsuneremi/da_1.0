...
import Helper.SQLConlection;
import java.sql.ResultSet;
import Model.SanPham;
import java.util.ArrayList;
import java.util.List;
import Reposioty.HoaDonChiTietRepository;
...
public class HoaDonChiTietRepositoryImpl implements HoaDonChiTietRepository {
    ...
    public void insert(HoaDonChiTiet Entity) {
        Helper.SQLConlection.update(INSERT_SQL, Entity.getID_Hoadon(), Entity.getID_SanPHam(), Entity.getSoluong(), Entity.getGia(), Entity.getTongGia(), Entity.isTrangThai(), Entity.getLyDoHuy(), Entity.getGhiChu());
    }

    @Override
    public void delete(HoaDonChiTiet Entity) {
        Helper.SQLConlection.update(UPDATE_SQL_TrangThai, Entity.isTrangThai(), Entity.getID_Hoadon(), Entity.getID_SanPHam());
    }
    ...
    public List<HoaDonChiTiet> selectBySql(String sql, Object... args) {
        ...
        try {
            ResultSet rs = SQLConlection.query(sql, args);
            while (rs.next()) {
    ...
    public void update_SL(HoaDonChiTiet Entity) {
        Helper.SQLConlection.update(UPDATE_SQL_soluong, Entity.getSoluong(), Entity.getTongGia(), Entity.getGhiChu(), Entity.getGia(), Entity.getID_Hoadon(), Entity.getID_SanPHam());
    }

    @Override
    public void update_LD(HoaDonChiTiet Entity) {
        Helper.SQLConlection.update(UPDATE_LY_DO_HUY, Entity.getLyDoHuy(), Entity.getID_Hoadon(), Entity.getID_SanPHam());
    }

    public void update_ghichu(HoaDonChiTiet Entity) {
        Helper.SQLConlection.update(UPDATE_Ghi_chu, Entity.getGhiChu(), Entity.getID_Hoadon(), Entity.getID_SanPHam());
    }
    ...
    public void updateIDHOADON(int macu, int mamoi, String iSP) {
        Helper.SQLConlection.update(UPDATE_SQL_IDHoaDon, mamoi, macu, iSP);
    }

    public void deletehoadonct(int mahd, String masp) {
        Helper.SQLConlection.update(DELETE_SQL, mahd, masp);
    }
