...
import Reposioty.BanRepository;
//sua ban
/**
 *
 * @author HP
...
//        "AND dbo.HoaDon.TTThanhtoan = 0 AND Donchinh = 1 AND dbo.HoaDon.ID_Hoadon = ?";
    ...
    public void insert(Ban Entity) {
        Helper.SQLConlection.update(INSERT_SQL, Entity.getIdBan(), Entity.isTrangThai(),Entity.isHoatDong(),Entity.getSoluongcho());
    }

    @Override
    public void updateTrangThai(int id) {
        Helper.SQLConlection.update(UPDATE_SQL_TRANGTHAI, id);
    }

    @Override
    public void deleteTRangThai(int id) {
        Helper.SQLConlection.update(DELETE_SQL_TRANGTHAI, id);
    }
...
//    }
    ...
    public void updateHoatDong(int id) {
        Helper.SQLConlection.update(UPDATE_SQL_HD, id);
    }

    @Override
    public void deleteHoatDong(int id) {
        Helper.SQLConlection.update(DELETE_SQL_HD, id);
    }
    ...
    public void delete(int id) {
        Helper.SQLConlection.update(DELETE, id);
    }
    ...
    public void update(Ban Entity) {
        Helper.SQLConlection.update(UPDATE_SQL, Entity.getSoluongcho(), Entity.isTrangThai(), Entity.isHoatDong(), Entity.getIdBan());
    }
